...
function InstallYubicoTools {
    Write-Host "Yubico Tools"
    Write-Host "-------------------------------------------------------------------"

    Write-Host "Yubico Authenticator"

    # Be careful. It installs Autohotkey which is flagged as a virus by Defender.
    # Installing is not dependent on Autohotkey, But Uninstall is. Avoid for now.
...
function DockerandVMTools {
    Write-Host "Docker and VM Tools"
    Write-Host "-------------------------------------------------------------------"
    Write-Host "Docker"
...
function InstallKubernetesTools { 
    Write-Host "Installing Kubernetes Tools"
    Write-Host "-------------------------------------------------------------------"
    Write-Host "Changing ChocolateyToolsLocation To C:\Tools\Kubernetes"
    $Env:ChocolateyToolsLocation = "C:\Tools\Kubernetes"
...
# Kubernetes
# Disabled Kubernetes because Chocolaty uses shims which might interfere with applocker.
